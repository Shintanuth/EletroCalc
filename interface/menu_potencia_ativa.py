from interface.menu_potencia_ativa_potencia_aparente_fator_de_potencia import (
    menu_potencia_ativa_potencia_aparente_fator_de_potencia,
)
from interface.menu_potencia_ativa_potencia_aparente_potencia_reativa import (
    menu_potencia_ativa_potencia_aparente_potencia_reativa,
)
from interface.menu_potencia_ativa_tensao_corrente_fator_de_potencia import (
